...
In this article we presented an example how methods to discount the results of phase II can be included for the purpose of bias adjustment. Note, that this example is not restricted to time-to-event endpoints but can also be applied to binary and normally distributed endpoints. For more information on how to use the package, see:
...
* *Complex drug development programs:* Adapt to situations with multiple phase III trials, multi-arm trials, or multiple endpoints.
