...
The validation report is compiled using our fork of PHUSE's [`valtools`](https://github.com/LukasDSauer/valtools) package. We recommend using our fork where a few bugs were fixed and features were added. This changes were not yet merged into to the package's main repository. It can be installed by running the following command:
...
Ellis Hughes and the PHUSE Data Visualisation & Open Source Technology Working Group (2021): White Paper 059. R Package Validation Framework. https://advance.hub.phuse.global/wiki/spaces/WEL/pages/26804366/R+Package+Validation+Framework.