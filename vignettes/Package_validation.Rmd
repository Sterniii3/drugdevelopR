...
The validation report is compiled using the PHUSE's [`valtools`](https://github.com/phuse-org/valtools) package. We recommend using our forked branch were a few bugs were fixed that were not yet merged into to the package's main repository. It can be installed by running the following command:
