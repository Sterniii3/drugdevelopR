...
* Finally, as the prior distribution is the sum of two truncated normal distributions we need truncation values, `a` as the lower boundary for the truncation and `b` as the upper boundary. In our case we set `a=0.25` and `b=0.75`.
