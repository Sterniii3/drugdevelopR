  ...
  stepl2 <- Inf
   ...
   if(fixed){
     ...
     result <-  data.frame(u = round(Eud,2), Kappa = KAPPA[J], n2 = N2[I],
                           ...
                           c03 = c03, c2 = c2, c3 = c3, b1 = b1, b2 = b2, b3 = b3, taus = taus, gamma = gamma, case = case)
   }else{
     result <-  data.frame(u = round(Eud,2), Kappa = KAPPA[J], n2 = N2[I],
                           n3 = n3, n = N2[I] + n3,
                           pgo = round(pg,2), sProg = round(prob,2),
                           ...
                           steps1 = steps1, stepm1 = stepm1, stepl1 = stepl1,
                           alpha = alpha, beta = beta, c02 = c02,
                           c03 = c03, c2 = c2, c3 = c3, b1 = b1, b2 = b2, b3 = b3, taus = taus, gamma = gamma)
   }
