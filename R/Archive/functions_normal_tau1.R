...
Epgo_normal <-  function(kappa, n2, w, Delta1, Delta2, in1, in2, a, b, fixed, taus){

  if(fixed){
    return(
      pnorm((Delta1-taus-kappa)/sqrt(4/n2))  
    )
  }else{
    return(
...
En3_normal <-  function(kappa, n2, alpha, beta, w, Delta1, Delta2, in1, in2, a, b, fixed, taus){
...
EPsProg_normal <-  function(kappa, n2, alpha, beta, step1, step2, w, Delta1, Delta2, in1, in2, a, b, gamma, fixed, taus){
    ...
    return(
          integrate(function(y){
            ( pnorm(qnorm(1 - alpha) + step2/sqrt(y^2/c),
                    mean = (Delta1-taus+gamma)/sqrt(y^2/c),
                    sd = 1) -
  ...
  if(n2+n3>N){
    ...
    #output: expected utility Eud, En3, EsP, Epgo
      ...
      prob1 <-  EPsProg_normal(kappa = kappa, n2 = n2, alpha = alpha, beta = beta,
                             ...
                             w = w, Delta1 = Delta1, Delta2 = Delta2, in1 = in1, in2 = in2, a = a, b = b,
                             gamma = gamma, fixed = fixed, taus = taus)
