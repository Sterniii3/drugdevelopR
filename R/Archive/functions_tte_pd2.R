  ...
  if(n2+n3>N){
    ...
    if(K2+K3>K){
      ...
      prob11 <- EPsProg_tte_pdb(HRgo = HRgo, d2 = d2,
                           ...
                           w = w, hr1 = hr1, hr2 = hr2, 
                           id1 = id1, id2 = id2, 
                           gamma = gamma, fixed = fixed, a1 = 0, a2 = A)
      ...
      prob21 <- EPsProg_tte_pdb(HRgo = HRgo, d2 = d2,
                            ...
                            w = w, hr1 = hr1, hr2 = hr2, 
                            id1 = id1, id2 = id2, 
                            gamma = gamma, fixed = fixed, a1 = A, a2 = B)
      ...
      prob31 <- EPsProg_tte_pdb(HRgo = HRgo, d2 = d2,
                                ...
                                w = w, hr1 = hr1, hr2 = hr2, 
                                id1 = id1, id2 = id2, 
                                gamma = gamma, fixed = fixed, a1 = B, a2 = Inf)
      ...
      prob1   <-  prob11 + prob21 + prob31
      prob2   <-  prob12 + prob22 + prob32 
      prob3   <-  prob13 + prob23 + prob33
