  ...
  if(fixed){
    ...
    return(
      integrate(function(x){
        sapply(x, function(x){
          integrate(function(y){
            ((2*(qnorm(1-alpha)*t2(x, p0)+qnorm(1-beta)*t3(x, p0))^2)/(y-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))^2) *
              dnorm(y,
                    mean = -log(x/p0),
...
EPsProg_binary_L <-  function(RRgo, n2, Adj, alpha, beta, step1, step2, p0, w, p11, p12, in1, in2, gamma, fixed){
    ...
    return(
      integrate(function(y){
        ( pnorm(qnorm(1 - alpha) -
                ...
                mean = -log((p11+gamma)/p0)/sqrt((t1(p11, p0)*(y-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))^2)/(qnorm(1-alpha)*t2(p11, p0) +
                                                                      qnorm(1-beta)*t3(p11, p0))^2),
                sd = 1) -
            pnorm(qnorm(1 - alpha) -
    ...
    return(
      integrate(function(x){
        sapply(x, function(x){
          integrate(function(y){
            ( pnorm(qnorm(1 - alpha) -
                      log(step2)/sqrt((t1(x, p0)*(y-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))^2)/(qnorm(1-alpha)*t2(x, p0) +
                                                         qnorm(1-beta)*t3(x, p0))^2),
                    mean = -log((x+gamma)/p0)/sqrt((t1(x, p0)*(y-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))^2)/(qnorm(1-alpha)*t2(x, p0) +
                                                                      qnorm(1-beta)*t3(x, p0))^2),
                    sd = 1) -
                pnorm(qnorm(1 - alpha) -
                        log(step1)/sqrt((t1(x, p0)*(y-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))^2)/(qnorm(1-alpha)*t2(x, p0) +
                                                           qnorm(1-beta)*t3(x, p0))^2),
                      mean = -log((x+gamma)/p0)/sqrt((t1(x, p0)*(y-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))^2)/(qnorm(1-alpha)*t2(x, p0) +
                                                                        qnorm(1-beta)*t3(x, p0))^2),
                      sd = 1) ) *
...
Epgo_binary_L2 <-  function(RRgo, n2, Adj, p0, w, p11, p12, in1, in2, fixed){
  if(fixed){
    ...
    return(
      integrate(function(x){
        sapply(x, function(x){
          pnorm((-log(x/p0) + log(RRgo)-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))/sqrt((2/n2)*t1(x, p0)))  *
            prior_binary(x, w, p11, p12, in1, in2)
        })
      },  0, 1)$value
    )
      ...
      integrate(function(y){
        ((2*(qnorm(1-alpha)*t2(p11, p0)+qnorm(1-beta)*t3(p11, p0))^2)/(y-qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))))^2) *
          dnorm(y,
                mean = -log(p11/p0),
                sd = sqrt((2/n2)*t1(p11, p0)))
      }, - log(RRgo)+qnorm(1-Adj)*sqrt(2/n((1-p0)/p0 +(1-p11/p11))), Inf)$value
    )
  }else{
    return(
      integrate(function(x){
...
# Expected probability of a successful program: EsP
EPsProg_binary_L2 <-  function(RRgo, n2, alpha, beta, step1, step2, p0, w, p11, p12, in1, in2, gamma, fixed){
...
utility_binary_L2 <-  function(n2, RRgo, Adj, w, p0, p11, p12, in1, in2,
  ...
  if(n2+n3>N){
    ...
    pg    <-  Epgo_binary_L2(RRgo = RRgo, n2 = n2, Adj = Adj, p0 = p0, w = w, p11 = p11, p12 = p12, in1 = in1, in2 = in2, fixed = fixed)
...
# Expected probability of a successful program: EsP
EPsProg_binary_R <-  function(RRgo, n2, Adj, alpha, beta, step1, step2, p0, w, p11, p12, in1, in2, gamma, fixed){
      ...
      integrate(function(y){
        ( pnorm(qnorm(1 - alpha) -
                  log(step2)/sqrt((t1(p11, p0)*(y*Adj)^2)/(qnorm(1-alpha)*t2(p11, p0) +
                                                       qnorm(1-beta)*t3(p11, p0))^2),
                mean = -log((p11+gamma)/p0)/sqrt((t1(p11, p0)*(y*Adj)^2)/(qnorm(1-alpha)*t2(p11, p0) +
                                                                      qnorm(1-beta)*t3(p11, p0))^2),
                sd = 1) -
            pnorm(qnorm(1 - alpha) -
          ...
          integrate(function(y){
            ( pnorm(qnorm(1 - alpha) -
                      log(step2)/sqrt((t1(x, p0)*(y*Adj)^2)/(qnorm(1-alpha)*t2(x, p0) +
                                                         qnorm(1-beta)*t3(x, p0))^2),
                    mean = -log((x+gamma)/p0)/sqrt((t1(x, p0)*(y*Adj)^2)/(qnorm(1-alpha)*t2(x, p0) +
                                                                      qnorm(1-beta)*t3(x, p0))^2),
                    sd = 1) -
                pnorm(qnorm(1 - alpha) -
...
# Utility function
utility_binary <-  function(n2, RRgo, Adj, w, p0, p11, p12, in1, in2,
                            alpha, beta, 
                            c2, c3, c02, c03, 
                            K, N, S,
                            steps1, stepm1, stepl1,
...
# Expected probability of a successful program: EsP
EPsProg_binary_R2 <-  function(RRgo, n2, Adj, alpha, beta, step1, step2, p0, w, p11, p12, in1, in2, gamma, fixed){
