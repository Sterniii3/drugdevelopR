...
box_normal <-function(w, Delta1, Delta2, in1, in2, a, b){
  w*rtnorm(100000,Delta2,sqrt(4/in1), lower = a, upper = b) +
    (1-w)*rtnorm(100000,Delta1,sqrt(4/in2), lower = a, upper = b)
}

# Expected probability to go to phase III: Epgo
Epgo_normal <-  function(kappa, n2, w, Delta1, Delta2, in1, in2, a, b){
...
En3_normal <-  function(kappa, n2, alpha, beta, w, Delta1, Delta2, in1, in2, a, b){
...
#utility function
utility_skipII_normal <-function(alpha, beta, c03, c3, b1, b2, b3, median_prior, K,
