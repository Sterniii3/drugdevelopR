...
Verify that the expected utility changes from 853.02 to 474.18 and the optimal sample size changes from 144 to 44 and from 456 to 172 in phase II and III respectively due to the cost constraint. The optimal adjustment parameter remains unchanged at 0.475. Furthermore verify, that the costs in phase II and III are 208 and 582 without the constraint and 133 and 263 with the constraint, i.e. the cost constraint is met at the optimal result.
...
Verify that both adjustment methods and the case with no bias adjustment return the same results, i.e. an expected utility of 75.8 and optimal sample sizes of 122 participants in phase II and 210 participants in phase III (i.e. a total sample size of 332).
