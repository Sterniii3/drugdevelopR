...
Verify that the expected utility changes from 853.02 (in 10^5\$) to 769.80 (in 10^5\$) and the optimal sample size changes from 144 to 144 and from 456 to 710 in phase II and III respectively due to the probability constraint. Verify that the optimal adjustment parameter changes from 0.475 to 0.375. Furthermore verify that without the constraint, the probability of a successful program is 0.66, with a probability of 0.07, 0.21 and 0.38 for small, medium or large treatment effects; and that with the constraint, the probability of a successful program is 0.71, with a probability of 0.06, 0.19 and 0.46 for small, medium or large treatment effects. This means that the cost constraint is met at the optimal result.
...
Verify that the function returns an expected utility of 2779.11 (in 10^5\$), an optimal threshold value of 0.12 and an optimal sample size of 236 in phase II and 548 in phase III (i.e. 784 in total).
...
Verify that for the basic multiplicative method, the program returns an expected overall utility of 4336.42 (in 10^5\$), an adjustment parameter of 0.5 and optimal sample sizes of 102 in phase II and 544 in phase III (i.e. an overall sample size of 646). Verify that for the basic additive  method, it returns an expected overall utility of 3871.26 (in 10^5\$), an adjustment parameter of 0.1 and optimal sample sizes of 130 in phase II and 456 in phase III (i.e. an overall sample size of 586).
Moreover, verify that for the advanced multiplicative method ("multipl2"), the program returns an expected overall utility of 4336.37 (in 10^5\$), an adjustment parameter of 0.5 and optimal sample sizes of 98 in phase II and 536 in phase III (i.e. an overall sample size of 634). Finally, verify that for the advanced additive method ("add2"), the program returns an expected overall utility of 3870.71 (in 10^5\$), an adjustment parameter of 0.1 and optimal sample sizes of 134 in phase II and 426 in phase III (i.e. an overall sample size of 560).
