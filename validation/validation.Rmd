...
data.frame(Setting = c("01 Basic", "02 Bias", "03 Multitrial", "04 Multiarm",
                       "05 Multiple", "Total"),
           Duration = c(signif(dur01, digits = 3),
                        signif(dur02, digits = 3),
                        signif(dur03, digits = 3),
                        signif(dur04, digits = 3),
                        signif(dur05, digits = 3),
                        paste(signif(in_hours(dur01 + dur02 + dur03 + dur04 + 
