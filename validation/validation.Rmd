...
The validation suite was programmed using the *valtools* R package [4] and the report was generated using the same package together with the *bookdown* R package. We closely followed the R package validation framework [5] of the PHUSE Working Group on “Data Visualisation & Open Source Technology”.
...
```{r test-code-authors, eval=FALSE}
...
In the following section, we will specify functionality that the end user can expect from the *drugdevelopR* package. We will use the following terms in the text (following the definitions in [@preussler2020]):
...
<!-- # fixed by installing valtools from source and adapting the source code as -->
<!-- # described in: -->
<!-- # https://github.com/phuse-org/valtools/pull/222 -->
<!-- # or by simply downloading or fork from -->
<!-- # https://github.com/LukasDSauer/valtools -->
<!-- vt_file(vt_path(c("test_code/01_BasicSettingTestCode.R", -->
<!--                   "test_code/02_BiasAdjustmentTestCode.R")), -->
